...
public class app_steps {
	...
	public void i_want_to_clickeye() throws InterruptedException {
		loginhowsteps.clickeye();

	}

	@Then("^I forget my password$")
	public void i_forget_password() throws InterruptedException {
		loginhowsteps.forgetpassword();

	}
	@And("^I need to quit$")
	public void i_want_to_quit() throws Throwable {
		loginhowsteps.quit();
	}
}
